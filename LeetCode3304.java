public class LeetCode3304 {
    public static void main(String[] args) {
        ...
        //For example, performing the operation on "c" generates
        // "cd" and performing the operation on "zb" generates "zbac".

        //Return the value of the kth character in word, after
        // enough operations have been done for word to have at least k characters.
        //
        ...
        System.out.println(Solution.kthCharacter(k));
    }
        ...
        public static char kthCharacter(int k) {
            ...
            while (current.length() < k) {
                ...
                for (int i = 0; i < current.length(); i++) {
                    shifted.append((char)(current.charAt(i) + 1));
                }
