...
public class LeetCode225 {
    public static void main(String[] args) {
        ...
        that only push to back, peek/pop from front, size and is empty operations are valid.
        Depending on your language, the queue may not be supported
        natively. You may simulate a queue using a list or deque (double-ended queue)
    ...
    class MyStack {
        ...
        public int top() {
            rotateExceptLast();
            int x = queue.peek();   // look at the top
            queue.offer(queue.poll());  // restore original order
            return x;
        }
