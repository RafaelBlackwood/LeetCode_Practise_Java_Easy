...
public class LeetCode232 {
    ...
    static class MyQueue {
        ...
        private final Stack<Integer> in = new Stack<>();   // newest on top
        private final Stack<Integer> out = new Stack<>();  // oldest on top
        ...
        // Pop from the front: ensure 'out' has the front on top
        public int pop() {
            moveIfNeeded();
            return out.pop();
        }
